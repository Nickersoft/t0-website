...
export { default as GlobeDuotone } from "~icons/ph/globe-duotone";
export { default as LightningDuotone } from "~icons/ph/lightning-duotone";
export { default as NetworkDuotone } from "~icons/ph/network-duotone";
